...
class LeNet:
	...
	def _build(self, learning_rate):
		...
		# convolution: 32x32@3 -> 28x28@6 + relu
		conv1 = tf.nn.relu(layers.conv2d(self.X, 6, (5, 5)))
		# max pooling: 28x28@6 -> 14x14@6
		pool1 = layers.maxpool2d(conv1, (2, 2))
		# convolution: 14x14@6 -> 10x10@16 + relu
		conv2 = tf.nn.relu(layers.conv2d(pool1, 16, (5, 5)))
		# max pooling: 10x10@16 -> 5x5@16
		pool2 = layers.maxpool2d(conv2, (2, 2))
		# flatten: 5x5@16 -> 400
		flat = layers.flatten(pool2)
		# fully connected: 400 -> 120
		fc1 = layers.linear(flat, 120)
		# fully connected: 120 -> 84
		fc2 = layers.linear(fc1, 84)
