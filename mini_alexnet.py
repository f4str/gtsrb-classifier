...
class MiniAlexNet:
	...
	def _build(self, learning_rate):
		...
		# convolution: 32x32@3 -> 30x30@32 + relu
		conv1 = tf.nn.relu(layers.conv2d(self.X, 32, (3, 3)))
		# max pooling: 30x30@32 -> 15x15@32
		pool1 = layers.maxpool2d(conv1, (2, 2))
		# convolution: 15x15@32 -> 13x13@64 + relu
		conv2 = tf.nn.relu(layers.conv2d(pool1, 64, (3, 3)))
		# max pooling: 13x13@64 -> 6x6@64
		pool2 = layers.maxpool2d(conv2, (2, 2))
		# convolution: 6x6@64 -> 4x4@128 + relu
		conv3 = tf.nn.relu(layers.conv2d(pool2, 128, (3, 3)))
		# max pooling: 4x4@128 -> 2x2@128
		pool3 = layers.maxpool2d(conv3, (2, 2))
		# flatten: 2x2@128 -> 512
		flat = layers.flatten(pool3)
		# fully connected: 512 -> 256
		fc1 = layers.linear(flat, 256)
		# fully connected: 256 -> 96
		fc2 = layers.linear(fc1, 96)
		# fully connected: 96 -> 43
